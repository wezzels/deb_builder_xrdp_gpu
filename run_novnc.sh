...
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6080 --vnc 127.0.0.1:5900 &
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6081 --vnc 127.0.0.1:5901 &
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6082 --vnc 127.0.0.1:5902 &
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6083 --vnc 127.0.0.1:5903 &
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6084 --vnc 127.0.0.1:5904 &
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6085 --vnc 127.0.0.1:5905 & 
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6086 --vnc 127.0.0.1:5906 & 
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6087 --vnc 127.0.0.1:5907 & 
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6088 --vnc 127.0.0.1:5908 &
./novnc/noVNC-1.3.0/utils/novnc_proxy --listen 127.0.0.1:6089 --vnc 127.0.0.1:5909 &
